...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${cormorant.variable} ${dmSans.variable}`}>
      <head>
        {/* GTM — loads dataLayer, Conversion Linker, and GA4 */}
        <script
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        />
        {/* Google Ads — initialises gtag so send_to conversion hits work */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18276002948" />
        <script
          dangerouslySetInnerHTML={{
            __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','AW-18276002948');`,
          }}
        />
      </head>
